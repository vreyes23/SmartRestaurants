...
function readFromDB()
{
	...
	({
	  type: "GET",
	  url: "https://833c1344-ce44-4b24-b461-98b8faec0b65-bluemix.cloudant.com/smartrestaurants/_all_docs",
	  dataType: 'json',
	  async: false,
	  headers: {
      ...
      //"Access-Control-Allow-Headers: ": "Authorization",
	    "Authorization": "Basic " + btoa("thennegencelfinglygodycr" + ":" + "787e88b978422e10f4e8b25318ec8b4c067bb5d3")
	  },
	  //data: '{ "comment" }',
