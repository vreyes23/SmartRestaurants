...
/**
 * Created by oscarricaud on 12/8/16.
 */
public class ConversationDrinks extends AppCompatActivity {
    private String input_from_user = "";
    int counter = 0;
    private String rawText = "";
    private static final String LOG_TAG = "StT";
    private RecordWavMaster mic3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_conversationdrinks);
        ...
        mic3 = new RecordWavMaster();
        TextToSpeechActivity tts = new TextToSpeechActivity(getApplicationContext());
        tts.execute("This is the drinks menu, you can ask nicely for " +
                "a delicious large doctor pepper. Or if you are a coca cola type of person you can also ask for that.");
        ...
        pressButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (counter == 1) {
                    ...
                    findViewById(R.id.loadingCircle).setVisibility(View.INVISIBLE); // Hide loading circle
                    findViewById(R.id.textView12).setVisibility(View.INVISIBLE); // Hide "Recording..."
                    outputFilePath = mic3.recordWavStop();
                    findViewById(R.id.textView13).setVisibility(View.INVISIBLE); // Hide "Please wait..."
                    findViewById(R.id.textView23).setVisibility(View.VISIBLE); // Show "Loading..."
                    //stopRecording();
                    new ConversationDrinks.SpeechToTextTask().execute(""); // Do the magic and convert audio to a string.
                    new ConversationDrinks.ConversationTask().execute("");
                    counter = 0;
    ...
    private class ConversationTask extends AsyncTask<String, Void, String> {
        protected String doInBackground(String... strings) {
            ...
            String orderWorkspaceID = "c29a89bf-bc22-49a7-be6a-4f0e4b2aa383";
        ...
        protected void onPostExecute(String result) {
            ...
            confirmButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(ConversationDrinks.this, ConversationDrinks.class);
